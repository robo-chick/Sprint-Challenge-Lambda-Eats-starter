...
Matches the URL to a Route without having to type out the route. 

2. How would you explain form validation to someone who has never programmed before?

Forms are used in webpages for the user to enter data that is sent to the server for processing. The data, such as usernames, passwords and contact information,  that is entered into a form needs to be in the correct format and certain fields need to be filled in order for the form to be used effectively. This used to be done at the server, but form validation in Javascript provides a way to validate the data before sending it to the server by way of error messasges.

3. In 1-2 sentences, define end to end testing.

Confirms that all features work from the user's perspective when using an application or webpage.
